            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">252</span>双 <br> <a href="searchServlet?param=surf&type=运动鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">150</span>双 <br> <a href="searchServlet?type=凉鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">127</span>双 <br> <a href="searchServlet?type=帆布鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">100</span>双 <br> <a href="searchServlet?type=休闲鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">252</span>双 <br> <a href="searchServlet?type=拖鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">400</span>双 <br> <a href="searchServlet?type=靴子" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">44</span>双 <br> <a href="searchServlet?type=皮鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
                <div class="person-donate text-center">
                    ...
                    <div class="donate-info">
                        ...
                        <p>共有 <span class="text-success">89</span>双 <br>  <a href="searchServlet?type=雨鞋" class="link-underline fundraise-item">详情</a></p>
                    </div>
                </div>
            </div>
